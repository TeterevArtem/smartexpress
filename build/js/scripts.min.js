...
const closeBtn = document.querySelectorAll('.popup__close'),
  ...
  mobileCalcBtn = document.querySelectorAll('.mobile__menu_btn-calc'),
      ...
      if (popup === '.popup_map') {
        ...
        if ($('#map1')) {
          DG.then(function () {
            ...
            var marker = DG.marker([42.875628792354846, 74.58591048336129]).addTo(map).bindPopup('SmartEx - доставка товаров из-за границы');
          });
        }
      }
...
showPopup(mobileCalcBtn, '.wrapper', '.calculator__popup');
...
const loginBlock = document.querySelectorAll('.popup__block_login');
