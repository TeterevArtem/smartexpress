...
thirdForm.addEventListener('submit', () => {
  ...
  postUserData('http://localhost:4000/', formData)
})
...
function sendSuccess(form, name) {
...
(function () {
  const themeCheckboxs = document.querySelectorAll('.fake__theme-color_checkbox');
  const inputCheckbox = document.querySelectorAll('.theme_form__input')
  const wrapper = document.querySelector('.wrapper');
  ...
  themeCheckboxs.forEach(checkbox => {
