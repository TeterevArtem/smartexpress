...
const closeBtn = document.querySelectorAll('.popup__close'),
      ...
      mapButton = document.querySelectorAll('.contacts__link_map');
...
mapButton.forEach(button => {
  button.addEventListener('click', function(e) {
    e.preventDefault();
    $('.popup').fadeOut();
      $(button).closest('.header__item_contacts').find('.popup_map').fadeIn();
    ...
    DG.then(function() {
      ...
      marker = DG.marker([42.875628792354846, 74.58591048336129]).addTo(map).bindPopup('SmartEx - доставка товаров из-за границы');
