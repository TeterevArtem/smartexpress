...
(function () {
  const signBlock = document.querySelector('.signin__block'),
      firstForm = document.querySelector('#sign__form_1'),
      trueForm = document.querySelector('#sign__form_true'),
      falseForm = document.querySelector('#sign__form_false'),
      secondForm = document.querySelector('#sign__form_2'),
      thirdForm = document.querySelector('#sign__form_3'),
      successBlock = document.querySelector('#sign_form__success'),
      confirmBlock = document.querySelector('#sign_form__confirm'),
...
(function() {
  ...
  window.addEventListener('load', function () {
    const firstTabsItem = document.querySelector('.first__content_items');
...
window.addEventListener('load', function(){
  ...
  if(width > 768 && !document.body.classList.contains('loader')) {
    ...
    async function getTootipInfo () {
      let res = await fetch('http://localhost:3000/countryTooltipInfo')
      return await res.json();
    }
  }
});
